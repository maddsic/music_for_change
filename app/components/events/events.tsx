    ...
    <section id="events" className="w-full bg-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <h2 className="mt-4 text-4xl md:text-5xl font-extrabold text-black">Upcoming Events</h2>
        </div>
          ...
          {events.map((event, idx) => (
            ...
            >
              ...
              <div className="md:w-1/2 text-center md:text-left">
                ...
                <Button className="mt-6 bg-secondary text-white btn-hover px-6 py-2 rounded-md">
                  Learn More
                </Button>
              </div>
